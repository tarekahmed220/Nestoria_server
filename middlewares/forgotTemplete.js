export const forgotTemplete=(token)=>{
	return `<!DOCTYPE html>
									...
									<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
										<tr>
											<td style="background:#4e8991;text-align:center">
												<p style ="font-family:Arial,sans-serif;font-size:14px;color:white">if you did not request a password reset,<br/> please ignore this email</p>
												<br/>
                                                <br/>
                                                <br/>
                                                <br/>
												 <a href="http://localhost:3000/resetpassword" style="border: 1px solid #ffffff; font-family: Verdana, Arial,sans-serif; font-size:14px; mso-line-height-rule: exactly;line-height: 14px; text-decoration: none; padding: 10px 31px; color:  #ffffff; font-weight:bold;display: block;"">
						...
						<table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width:100%">
							<tr>
								<td class="tr_align" style="text-align:center;padding:10px">
							        ...
							        <img src="https://images.kemitt.com/img/product/images-1689083344507.jpg?class=Product" width="380" alt="" style="width:100%;max-width:380px;height:auto;display:block;border:0;background-color:#4e8991;">
									</div>
